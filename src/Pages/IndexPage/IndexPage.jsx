		...
		return (
			<div>
				...
				<ul>
					...
					<li><a href="https://developers.deezer.com/api">Dizzer API</a> — also for obtaining song's info (not so accurate)</li>
				</ul>
				<p>Website also tries to add widgets from following social medias: <b>YouTube</b>, <b>Dizzer</b>, <b>Spotify</b>, <b>Soundcloud</b>.</p>
				<p>
